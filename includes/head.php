...
<link rel="icon" type="image/x-icon" href="<?= PATH ?>/images/real_icon.png">
...
<link rel="stylesheet" href="<?= PATH ?>/css/mediaelementplayer.css">
<link rel="stylesheet" href="<?= PATH ?>/css/animate.css">
<link rel="stylesheet" href="<?= PATH ?>/fonts/flaticon/font/flaticon.css">
<link rel="stylesheet" href="<?= PATH ?>/css/fl-bigmug-line.css">
